...
import Seihou.Effect.BaselineStoreSpec qualified as BaselineStoreSpec
...
import Seihou.Engine.BaselineSpec qualified as BaselineSpec
...
import Seihou.Engine.ReconcileSpec qualified as ReconcileSpec
...
main = do
  ...
  baselineStoreTests <- BaselineStoreSpec.tests
  ...
  baselineTests <- BaselineSpec.tests
