...
This developer-facing log preserves detailed documentation audit history,
including links to internal plans and design notes. The release-facing user
changelog is `docs/user/CHANGELOG.md`.
